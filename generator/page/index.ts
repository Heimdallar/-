...
import { IFile, processGenerateFiles, promptsExitWhenCancel, type IArgsPage } from './utils';
...
const PAGE_TEMPLATE_DIR = join(__dirname, 'template/');
const DEFAULT_PAGE_NAME = 'unTitledPage';
const USER_TEMPLATE_PAGE_DIR = PAGE_TEMPLATE_DIR;
