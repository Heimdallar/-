...
import type { Data } from '../interface/queryAllCategoryOverview';

const buildMakeByAllCategoryGetOverview = () => {
  return function makeByAllCategoryGetOverview(record: Data) {
    if (!record) {
      return null;
    }
...
export default buildMakeByAllCategoryGetOverview;
