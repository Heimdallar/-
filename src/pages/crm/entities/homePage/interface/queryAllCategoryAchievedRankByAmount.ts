 ...
 */
export interface ByAllCategoryQueryAchievedRankByAmountRes {
  code?: number;
  /**
   * PageResponse
   */
  data?: ByAllCategoryQueryAchievedRankByAmountResData;
  domain?: string;
  /**
   * Error
   */
 ...
 * PageResponse
 */
export interface ByAllCategoryQueryAchievedRankByAmountResData {
  /**
   * T
   */
  datas?: DataElement[];
 ...
 */
export interface ByAllCategoryQueryAchievedRankByAmountReq {
  /**
   * 操作人Id
   */
  operatorId?: number;
