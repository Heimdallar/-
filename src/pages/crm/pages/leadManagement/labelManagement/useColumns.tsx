...
import { labelChannelOptions, statusOptions } from './config';
import { updateLabelStatus } from './api';


const useColumns = (setRow: React.Dispatch<React.SetStateAction<EditLabelItem | undefined>>, setLabelShow: React.Dispatch<React.SetStateAction<boolean>>, refreshList: () => void) => {
  const columns = useMemo<ProColumns<LabelItem, "text">[]>(() => {
    return [
      {
        title: '标签ID',
        dataIndex: 'id',
