...
import FollowUpLog from '@/pages/leadManagement/privateSea/components/followUpLog';
import useBasicsColumns from '@/pages/leadManagement/privateSea/components/detailDrawer/useBasicsColumns';
import useEnterpriseEnterColumns from '@/pages/leadManagement/privateSea/components/detailDrawer/useEnterpriseEnterColumns';
import useEnterpriseColumns from '@/pages/leadManagement/privateSea/components/detailDrawer/useEnterpriseColumns';
import { useColumns } from '@/pages/leadManagement/privateSea/config';
import { getPublicSeaRealMsg } from '../../api';
