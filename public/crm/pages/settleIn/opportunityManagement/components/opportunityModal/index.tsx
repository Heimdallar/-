...
import fetchMerchantQueryManagerInfoService from '@/services/settingColumnsModal/queryManagerInfo';
import type { Data } from '@/entities/settingColumnsModal/interface/queryManagerInfo';
import { saveBrand } from '../../api';
import { IncentiveOptions, QualificationOptions } from '../../config/index';
...
export default ({ opportunityShow, SetOpportunityShow, row, setRow, refreshList }: styleParam) => {
  ...
  const [options, setOptions] = useState<Data[]>([]); // 对接人下拉列表
